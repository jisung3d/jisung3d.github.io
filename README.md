# Jisung Yoo — research portfolio

Static HTML/CSS portfolio at https://jisung3d.github.io/. No build step, analytics, or application login is required.
...
Sharing metadata uses `assets/social-preview.png` (1200×630) and a JY favicon. Editable SVG sources are included. Mobile publication entries put the full-width title and text before a compact figure; larger screens keep figures on the left.
